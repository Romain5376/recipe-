...
class Aliment
{
     ...
     * @Assert\Length(min=3,max=20,minMessage="Le nom doit faire 3 caractères minimum",
     * maxMessage="Le nom doit faire 20 caractères maximum")
     */
    private $nom;
     ...
     * @Assert\Expression(
     * "(this.getPrix() > 0 and this.getPrix() <= 100)" ,message="Le prix doit être compris entre 0.1€ et 100€")
     */
    private $prix;
